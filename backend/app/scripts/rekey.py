...
SCALAR_FIELDS: tuple[RekeyField, ...] = (
    ...
    RekeyField("system_agent_action", "id", "secret_payload_enc"),
    RekeyField("system_agent_pending_turn", "id", "content_enc"),
    RekeyField("system_agent_run_input", "id", "payload_enc"),
)
