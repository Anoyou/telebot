...
//   5) openapi/telepilot.openapi.json        ← 运行 make codegen 从后端版本生成，勿手改
//
...
export const APP_VERSION = "0.88.0-beta.10";
export const APP_STAGE: string | null = null;
